...
Route::group(['prefix' => 'admin'], function () {
  ...
  Route::post('/updateSiteInfo', [App\Http\Controllers\Admin\ERP\AdminController::class, 'updateSiteInfo'])->name('updateSiteInfo')->middleware(['auth:admin']);

  Route::get('/profile', [App\Http\Controllers\Admin\ERP\AdminController::class, 'profile'])->name('profile')->middleware(['auth:admin']);
  Route::post('/updateProfile', [App\Http\Controllers\Admin\ERP\AdminController::class, 'updateProfile'])->name('updateProfile')->middleware(['auth:admin']);
  ...
  Route::post('/newUnit', [App\Http\Controllers\Admin\ERP\UnitController::class, 'newUnit'])->name('newUnit')->middleware(['auth:admin']);
  Route::post('/updateUnit', [App\Http\Controllers\Admin\ERP\UnitController::class, 'updateUnit'])->name('updateUnit')->middleware(['auth:admin']);
  Route::post('/deleteUnit', [App\Http\Controllers\Admin\ERP\UnitController::class, 'deleteUnit'])->name('deleteUnit')->middleware(['auth:admin']);

  Route::get('/ingredients', [App\Http\Controllers\Admin\ERP\IngredientController::class, 'ingredients'])->name('ingredients')->middleware(['auth:admin']);
  Route::post('/newIngredient', [App\Http\Controllers\Admin\ERP\IngredientController::class, 'newIngredient'])->name('newIngredient')->middleware(['auth:admin']);
  Route::post('/updateIngredient', [App\Http\Controllers\Admin\ERP\IngredientController::class, 'updateIngredient'])->name('updateIngredient')->middleware(['auth:admin']);
  Route::post('/deleteIngredient', [App\Http\Controllers\Admin\ERP\IngredientController::class, 'deleteIngredient'])->name('deleteIngredient')->middleware(['auth:admin']);

  Route::get('/inventory',[App\Http\Controllers\Admin\ERP\StockController::class, 'inventory'])->name('inventory')->middleware(['auth:admin']);

  Route::get('/stockIn',[App\Http\Controllers\Admin\ERP\StockController::class, 'stockIn'])->name('stockIn')->middleware(['auth:admin']);
  Route::post('/newStockIn',[App\Http\Controllers\Admin\ERP\StockController::class, 'newStockIn'])->name('newStockIn')->middleware(['auth:admin']);

  Route::get('/products', [App\Http\Controllers\Admin\ERP\ProductController::class, 'products'])->name('products')->middleware(['auth:admin']);
  Route::post('/newProduct', [App\Http\Controllers\Admin\ERP\ProductController::class, 'newProduct'])->name('newProduct')->middleware(['auth:admin']);
  Route::post('/updateProduct', [App\Http\Controllers\Admin\ERP\ProductController::class, 'updateProduct'])->name('updateProduct')->middleware(['auth:admin']);
  Route::post('/deleteProduct', [App\Http\Controllers\Admin\ERP\ProductController::class, 'deleteProduct'])->name('deleteProduct')->middleware(['auth:admin']);

  Route::get('/recipes', [App\Http\Controllers\Admin\ERP\RecipeController::class, 'recipes'])->name('recipes')->middleware(['auth:admin']);
  Route::post('/newRecipe', [App\Http\Controllers\Admin\ERP\RecipeController::class, 'newRecipe'])->name('newRecipe')->middleware(['auth:admin']);
  Route::post('/updateRecipe', [App\Http\Controllers\Admin\ERP\RecipeController::class, 'updateRecipe'])->name('updateRecipe')->middleware(['auth:admin']);
  Route::post('/deleteRecipe', [App\Http\Controllers\Admin\ERP\RecipeController::class, 'deleteRecipe'])->name('deleteRecipe')->middleware(['auth:admin']);

  Route::get('/production', [App\Http\Controllers\Admin\ERP\ProductionController::class, 'production'])->name('production')->middleware(['auth:admin']);
  Route::post('/produce', [App\Http\Controllers\Admin\ERP\ProductionController::class, 'recordProduction'])->name('produce')->middleware(['auth:admin']);
  Route::get('/productionHistory', [App\Http\Controllers\Admin\ERP\ProductionController::class, 'productionHistory'])->name('productionHistory')->middleware(['auth:admin']);

  Route::get('/pos', [App\Http\Controllers\Admin\ERP\POSController::class, 'pos'])->name('pos')->middleware(['auth:admin']);
  ...
  Route::post('/deleteAdmin', [App\Http\Controllers\Admin\ERP\AdminController::class, 'deleteAdmin'])->name('deleteAdmin')->middleware(['auth:admin']);
  ...
  Route::post('/addIngredientOpeningStock', [App\Http\Controllers\Admin\ERP\OpeningStockController::class, 'addIngredientStock'])->name('addIngredientOpeningStock')->middleware(['auth:admin']);
