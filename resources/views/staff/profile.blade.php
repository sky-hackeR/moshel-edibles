    ...
    <div class="col-xl-4">
        <div class="card overflow-hidden">
            <div class="bg-primary-subtle p-3 d-flex align-items-center justify-content-between">
                <div>
                    <h5 class="text-primary mb-0">Welcome {{ explode(' ', $staff->name)[0] }}!</h5>
                </div>
                    ...
                    <div class="flex-shrink-0">
                        <div class="avatar-md shadow-sm" style="width: 100px; height: 100px;">
                            <span class="avatar-title bg-primary text-white display-5" style="border-radius: 10px !important;">
                                {{ $staff->name ? strtoupper(substr($staff->name, 0, 1)) : 'S' }}
                            </span>
                        </div>
                    </div>
        
                    <div class="flex-grow-1">
                        <h5 class="font-size-15 text-truncate mb-1">{{ $staff->name }}</h5>
                        <p class="text-muted mb-0 text-truncate">Staff Member</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                ...
                <div class="accordion" id="staffProfileAccordion">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseAccount" class="accordion-collapse collapse show" data-bs-parent="#staffProfileAccordion">
                            <div class="accordion-body">
                                <form action="{{ url('/staff/updateProfile') }}" method="POST">
                                    @csrf
                                    <div class="row">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseSecurity" class="accordion-collapse collapse" data-bs-parent="#staffProfileAccordion">
                            <div class="accordion-body">
